import { Component, createContext, PropsWithChildren, useState } from "react";
...
Carousel.Content = ({data,render} : {data: unknown[],render: (data: unknown) => Component}) => {
    return <>
        {
            data.map((item, index) => render(item) )
        }
    </>
}
